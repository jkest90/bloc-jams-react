            ...
            <div className="container-fluid">
               <div className="row">
                  <ul className="nav-bar col-xs-12">
                        <li><Link to="/"><img src="/assets/images/bloc_logo.png" alt="bloc logo"/></Link></li>
                        <li><Link to="/"><h1> BLOC <em> JAMS </em></h1></Link></li>
                        <li className="my-music"><Link to="/library"><h2>MY MUSIC</h2></Link></li>
                  </ul>
